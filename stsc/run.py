...
def run(prs: arp.ArgumentParser,
    ...
    if not all(args.sc_fit):
        ...
        sc_data = D.make_sc_dataset(args.sc_cnt,
                                    ...
                                    top_criteria=args.top_criteria,
        ...
        sc_loss_tracker = utils.LossTracker(oname_loss_track, interval=100)
    ...
    if args.st_cnt[0] is not None:
        ...
        # NOTE we do not want to filter by top n genes in the ST dataset since we
        # perform the intersection after fitting the SC models
        ...
        st_loss_tracker = utils.LossTracker(oname_loss_track, interval=100)
